...
public class ProviderService {
    ...
    //add sans ajout image(upload)
	/*
	 * public Provider createProvider( Provider provider) { return
	 * providerRepository.save(provider); }
	 */
    
    
  //add avec ajout image(upload)
	public Provider createProvider(MultipartFile file, String name, String email, String address) throws IOException {
	 ...
	 * public Provider editProvider( Long providerId, Provider providerRequest) {
	 * return providerRepository.findById(providerId).map(provider -> {
	 * provider.setName(providerRequest.getName());
	 * provider.setAddress(providerRequest.getAddress());
	 * provider.setEmail(providerRequest.getEmail()); return
	 * providerRepository.save(provider); }).orElseThrow(() -> new
